...
# The science of [collecting]{style="color:red;"}, analyzing, presenting, and interpreting [data]{style="color:blue;"}.
...
# The science of [collecting]{style="color:blue;"}, [analyzing]{style="color:red;"}, presenting, and interpreting [data]{style="color:blue;"}.
...
```{r, echo=FALSE}
library(kableExtra)
head(df, 50) |> knitr::kable() |> kable_styling(font_size = 20)
```
...
# The science of [collecting]{style="color:blue;"}, [analyzing]{style="color:blue;"}, [presenting, and interpreting]{style="color:red;"} [data]{style="color:blue;"}.

---

## Presenting Data: Example

[https://thiyangt.github.io/dsjobtraker_dashboard_mc/#top-software-and-skills](https://thiyangt.github.io/dsjobtraker_dashboard_mc/#top-software-and-skills)
...
# The [science]{style="color:red;"} of [collecting]{style="color:blue;"}, [analyzing]{style="color:blue;"}, [presenting, and interpreting]{style="color:blue;"} [data]{style="color:blue;"}.
