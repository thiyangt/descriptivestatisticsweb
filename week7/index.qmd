...
## Step 4: Claculate lower class limits/ class interval
...
```{r}
df = data.frame(CL = c("6-18", "19-31", "32-44", "45-57", "58-70", "71-83", "84-96"))
df |> kable()
```
...
```{r}
df = data.frame(CL = c("6-18", "19-31", "32-44", "45-57", "58-70", "71-83", "84-96"),Tally = c("", "", "", "","", "", ""), Frequency= c(6, 6, 12, 6, 4, 8, 8))
df |> kable()
```
...
$$c= \text{difference between successive lower class limits}$$

or 

$$c= \text{difference between successive upper class limits}$$
