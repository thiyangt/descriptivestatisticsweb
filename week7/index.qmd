...
```{r}
df3 = data.frame(
                Boundaries = c("less than or 18.5", "less than or 31.5", "less than or 44.5", "less than or 57.5",  "less than or 70.5", "less than or 83.5", "less than or 96.5"),
...
```{r}
df4 = data.frame(
                Boundaries = c( "greater than 5.5", "greater than 18.5", "greater than 31.5", "greater than 44.5", "greater than 57.5",  "greater than 70.5", "greater than 83.5"),
